...
""" def test_bot():
    ...
    # Для тестування
    print(run("add Mykhailo 1234567890"))               # Contact added.
    print(run("add Mykhailo 0987654321"))               # Contact updated.
    print(run("phone Mykhailo"))                        # Обидва телефони
    print(run("change Mykhailo 1234567890 1111111111")) # Заміна
    print(run("phone Mykhailo"))                        # Новий номер
    print(run("add-birthday Mykhailo 11.11.2002"))      # Додано ДН
    print(run("show-birthday Mykhailo"))                # Показати ДН
